...
@Disabled
@Autonomous(name="TXCBlueAutoInner", group="TXCRedAuto")
public class TXCBlueAutoInner extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        com.acmerobotics.roadrunner.geometry.Pose2d startPose2 = new com.acmerobotics.roadrunner.geometry.Pose2d(-61.5, 17, Math.toRadians(0));
        ...
        Trajectory move3 = drive.trajectoryBuilder(startPose2)
                .lineToLinearHeading(
                        new com.acmerobotics.roadrunner.geometry.Pose2d(-7, 17, Math.toRadians(0
                        )),
        ...
        Trajectory four1 = drive.trajectoryBuilder(move2.end())
                .lineToLinearHeading(
                        new com.acmerobotics.roadrunner.geometry.Pose2d(50, 68, Math.toRadians(0)),
                        new MinVelocityConstraint(
                                Arrays.asList(
                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                        new MecanumVelocityConstraint(40, DriveConstants.TRACK_WIDTH)
        ...
        if(choiceO == 0 || choiceO == 1) {
            ...
            if (rings == 4) {
                ...
                robot.wgOpen();
                robot.updateAll();
                startPose2 = four1.end();
            }

            if(rings != 0 ) {

                Trajectory move11_01 = drive.trajectoryBuilder(startPose2)
                        .lineToLinearHeading(
                                new com.acmerobotics.roadrunner.geometry.Pose2d(-29, 65, Math.toRadians(0)),
                                new MinVelocityConstraint(
                                        Arrays.asList(
                                                new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                                new MecanumVelocityConstraint(40, DriveConstants.TRACK_WIDTH)
                ...
                drive.followTrajectory(move11_01);
                robot.dropDown();

                Trajectory move2_01 = drive.trajectoryBuilder(drive.getPoseEstimate())
                        .lineToLinearHeading(
                                new com.acmerobotics.roadrunner.geometry.Pose2d(-30, 37, Math.toRadians(0)),
                                new MinVelocityConstraint(
                                        Arrays.asList(
                                                new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                ...
                Trajectory move3_01 = drive.trajectoryBuilder(move2_01.end())
                        .lineToLinearHeading(
                                new com.acmerobotics.roadrunner.geometry.Pose2d(-22, 37, Math.toRadians(0)))
                        .build();
                ...
                Trajectory move4_01 = drive.trajectoryBuilder(move3_01.end())
                        .lineToLinearHeading(
                                new com.acmerobotics.roadrunner.geometry.Pose2d(-10, 37, Math.toRadians(0)),
                                new MinVelocityConstraint(
                                        Arrays.asList(
                                                new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                                new MecanumVelocityConstraint(20, DriveConstants.TRACK_WIDTH)
            ...
            if(choiceO == 0) {
                Trajectory move10_0 = drive.trajectoryBuilder(drive.getPoseEstimate())
                        .lineToLinearHeading(
                                new com.acmerobotics.roadrunner.geometry.Pose2d(-29, 46, Math.toRadians(0)),
                                new MinVelocityConstraint(
                                        Arrays.asList(
                                                new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                                new MecanumVelocityConstraint(20, DriveConstants.TRACK_WIDTH)
                ...
                Trajectory move12_0 = drive.trajectoryBuilder(drive.getPoseEstimate())
                        .lineToLinearHeading(
                                new com.acmerobotics.roadrunner.geometry.Pose2d(-26, -60, Math.toRadians(0)),
                                new MinVelocityConstraint(
                                        Arrays.asList(
                                                new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                                new MecanumVelocityConstraint(30, DriveConstants.TRACK_WIDTH)
                ...
                if(rings == 0){
                    ...
                    drive.followTrajectory(move10_0);
                }
                ...
                if (rings == 0) {
                    Trajectory move6_0 = drive.trajectoryBuilder(drive.getPoseEstimate())
                            .lineToLinearHeading(
                                    new com.acmerobotics.roadrunner.geometry.Pose2d(15, 62, Math.toRadians(-90)),
                                    new MinVelocityConstraint(
                                            Arrays.asList(
                                                    new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                                    new MecanumVelocityConstraint(40, DriveConstants.TRACK_WIDTH)
                ...
                if (rings == 1) {
                    Trajectory move7_0 = drive.trajectoryBuilder(drive.getPoseEstimate())
                            .lineToLinearHeading(
                                    new com.acmerobotics.roadrunner.geometry.Pose2d(30, 47, Math.toRadians(180)),
                                    new MinVelocityConstraint(
                                            Arrays.asList(
                                                    new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                                    new MecanumVelocityConstraint(40, DriveConstants.TRACK_WIDTH)
                ...
                if (rings == 4) {
                    Trajectory move8_0 = drive.trajectoryBuilder(drive.getPoseEstimate())
                            .lineToLinearHeading(
                                    new com.acmerobotics.roadrunner.geometry.Pose2d(50, 74 , Math.toRadians(-170)),
                                    new MinVelocityConstraint(
                                            Arrays.asList(
                                                    new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                                    new MecanumVelocityConstraint(50, DriveConstants.TRACK_WIDTH)
        ...
        Trajectory move9_2 = drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(
                        new com.acmerobotics.roadrunner.geometry.Pose2d(15, 12   , Math.toRadians(0)),
                        new MinVelocityConstraint(
                                Arrays.asList(
                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
