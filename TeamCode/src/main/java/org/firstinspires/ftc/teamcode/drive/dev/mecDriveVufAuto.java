...
@Disabled
@TeleOp(name="mecDriveVufAuto", group="Linear Opmode")
public class mecDriveVufAuto extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()) {
            ...
            if (targetVisible) {
                ...
                X = translation.get(1) / mmPerInch + 8;
                Y = translation.get(0) / mmPerInch - 7;
